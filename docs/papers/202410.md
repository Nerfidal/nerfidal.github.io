...
|:---:|:---:|:---:|:---:|
| 2024-10-31 | Chen Zhao, Xuan Wang, Tong Zhang, Saqib Javed, Mathieu Salzmann | cs.CV | [PDF](http://arxiv.org/pdf/2411.00144v1){: .btn .btn-green } |

**Abstract**: 3D Gaussian Splatting (3DGS) has demonstrated remarkable effectiveness for
...
code is released at https://github.com/sailor-z/SE-GS.
...
| Published | Authors | Category | |
|:---:|:---:|:---:|:---:|
| 2024-10-31 | Shaohua Liu, Junzhe Lu, Zuoya Gu, Jiajun Li, Yue Deng | cs.CV | [PDF](http://arxiv.org/pdf/2411.00239v1){: .btn .btn-green } |
...
**Abstract**: Recent breakthroughs in text-guided image generation have significantly
...
**Abstract**: Scanning Electron Microscopes (SEMs) are widely renowned for their ability to
