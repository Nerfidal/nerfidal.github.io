...
| Published | Authors | Category | |
|:---:|:---:|:---:|:---:|
| 2024-01-17 | Win Kent Ong, Kam Woh Ng, Chee Seng Chan, Yi Zhe Song, Tao Xiang | cs.CV | [PDF](http://arxiv.org/pdf/2401.09495v3){: .btn .btn-green } |
...
Comments:
- Error on result tabulation for the state of the art method which
  might cause misleading to the readers
